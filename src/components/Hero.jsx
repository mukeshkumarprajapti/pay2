...
const Hero = () => {
  return (
    <div className="bg-[#0C111C] ">
      <div className="container  mx-auto lg:flex justify-between items-center p-16 lg:py-28  text-white gap-10">
        <div className="basis-1/2">
          ...
          <h1 className="text-xl font-semibold py-4 ">
            JamsrPay: Revolutionizing cryptocurrency transactions with
            cutting-edge technology. Seamless integration, unparalleled
            security, and lightning-fast settlements.
          </h1>
          <div>
            <div className="flex gap-3 items-center py-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-check text-green-500 h-6 w-6 flex-shrink-0"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
              <div>
          ...
          <div className="md:flex p-4 gap-3">
            <Button color="primary" size="lg" radius="full" className="m-2">
              Get Started &#8594;{" "}
            </Button>
            <Button color="default" size="lg" radius="full" className="m-2">
              Schedule Demo
            </Button>
          </div>
        </div>
        <div className=" basis-1/2 bg-black shadow-xl shadow-indigo-700/30 ">
          <Image
